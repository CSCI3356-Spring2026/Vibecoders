...
def listing_card_payload(listing):
    ...
    return {
        ...
        "space_type": listing.get_space_type_display(),
        "renter_requirements": Truncator(listing.renter_requirements).words(10, truncate="..."),
        "estimated_upfront_total": f"${listing.estimated_upfront_total:.0f}",
